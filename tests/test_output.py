...
class test_opppy_outputs(unittest.TestCase):
  def test_get_output_lines(self):
    ...
    cycle_strings = get_output_lines("example_output.txt","#cycle","#cycle","#end of file")
    print("All Data: ", cycle_strings)
    # only read cycle 1 data 
    cycle_strings2 = get_output_lines("example_output.txt","#cycle","#cycle")
    print("Cycle 1 Data:",cycle_strings2)
    # only read cycle 2 data
    cycle_strings3 = get_output_lines("example_output.txt","#cycle 2","#")
    print("Cycle 2 Data:", cycle_strings3)
    # only read cycle 2 data
    cycle_strings4 = get_output_lines("example_output.txt","#","#")
    print("No end file data:", cycle_strings4)
    # read nothing
    cycle_strings5 = get_output_lines("example_output.txt","#","junk")
    print("Bad end cycle string so no data:", cycle_strings5)
    # read nothing
    cycle_strings6 = get_output_lines("example_output.txt","junk","#")
  ...
  def test_append_output_dictionary(self):
    ...
    output_files = ["output_example1.txt"]
    ...
    output_files = ["output_example2.txt"]
    # Build initial pickle
    append_output_dictionary(data, output_files, opppy_parser)
    ...
    output_files = ["output_example3.txt"]
    # Build initial pickle
    append_output_dictionary(data, output_files, opppy_parser)
