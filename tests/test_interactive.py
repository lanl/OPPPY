...
class test_interactive_utils(unittest.TestCase):
    ...
    def test_pickle_output(self):
        ...
        os.system("python my_interactive_parser.py output pickle -pf interactive.p -of "+dir_path+"output_example*.txt")

    def test_plot_pickle(self):
        # This uses glob to pickle all the output data
        os.system("python my_interactive_parser.py output pickle -pf interactive.p -of "+dir_path+"output_example*.txt")
        # This uses glob to pickle all the output data
        os.system("python my_interactive_parser.py output iplot -pf interactive.p < "+dir_path+"interactive_input.txt")
        # parse and plot the output data files
        os.system("python my_interactive_parser.py output iplot -of "+dir_path+"output_example*.txt < "+dir_path+"interactive_input.txt")
    ...
    def test_plot_dictionary(self):
        ...
        # parse and plot the output data files
        os.system("python my_interactive_parser.py output plot -of "+dir_path+"output_example*.txt -dn density -x time -y mat1 -sa density_mat1_pp.png -hp")

    def test_pickle_dumps(self):
        # This uses glob to pickle all the dump data
        os.system("python my_interactive_parser.py dump pickle -pf interactive_dump.p -df "+dir_path+"example_dump*.txt")
    ...
    def test_plot_dump(self):
        ...
        os.system("python my_interactive_parser.py dump 1d -dn "+dir_path+"example_dump.txt -x cell_id -y temperature")

        # Parse and plot a 1d dump
        os.system("python my_interactive_parser.py dump 1d -dn "+dir_path+"example_dump.txt -x cell_id -y temperature -kw cell_id temperature")

        # plot a 1d dump from a pickle file
        os.system("python my_interactive_parser.py dump 1d -dn "+dir_path+"example_dump.txt -pf interactive_dump.p -x cell_id -y temperature")

        # Parse and plot a 2d dump
        os.system("python my_interactive_parser.py dump 2d -dn "+dir_path+"example_dump.txt -x cell_id -y z -d temperature")

        # plot 2d dump from pickle file
        os.system("python my_interactive_parser.py dump 2d -dn "+dir_path+"example_dump.txt -pf interactive_dump.p -x cell_id -y z -d density")

        # Parse and plot a 2d dump only extract key_words
        os.system("python my_interactive_parser.py dump 2d -dn "+dir_path+"example_dump.txt -x cell_id -y z -d temperature -kw temperature cell_id z")

        # plot slice of 3d dump from dump file
        os.system("python my_interactive_parser.py dump 3d -dn "+dir_path+"example_dump.txt -x z -y y -z x -zs 5.0 -d temperature")

        # plot slice of 3d dump from pickle file
        os.system("python my_interactive_parser.py dump 3d -dn "+dir_path+"example_dump.txt -pf interactive_dump.p -x z -y y -z x -zs 5.0 -d temperature")
    ...
    def test_dump_series(self):
        ...
        os.system("python my_interactive_parser.py dump point -df "+dir_path+"example_dump*.txt -df "+dir_path+"example_dump*.txt -dk x -p 5 -s time -d temperature -sy 10.0 -sy 1.0")

        # test individual scale x
        os.system("python my_interactive_parser.py dump point -df "+dir_path+"example_dump*.txt -df "+dir_path+"example_dump*.txt -dk x -p 5 -s time -d temperature -sx 10.0 -sx 1.0")

        # test scale all x
        os.system("python my_interactive_parser.py dump point -df "+dir_path+"example_dump*.txt -df "+dir_path+"example_dump*.txt -dk x -p 5 -s time -d temperature -sx 10.0")

        # test scale all y
        os.system("python my_interactive_parser.py dump point -df "+dir_path+"example_dump*.txt -df "+dir_path+"example_dump*.txt -dk x -p 5 -s time -d temperature -sy 10.0")
    ...
    def test_pickle_tally(self):
        # This uses glob to pickle all the output data
        os.system("python my_interactive_parser.py tally pickle -pf interactive_tally.p -of "+dir_path+"example_tally*.txt")

    def test_plot_tally(self):
        # This uses glob to pickle all the output data
        os.system("python my_interactive_parser.py tally pickle -pf interactive_tally.p -tf "+dir_path+"example_tally*.txt")
        # This uses glob to pickle all the output data
        os.system("python my_interactive_parser.py tally iplot -pf interactive_tally.p < "+dir_path+"interactive_tally_input.txt")
        # parse and plot the output data files
        os.system("python my_interactive_parser.py tally iplot -tf "+dir_path+"example_tally*.txt < "+dir_path+"interactive_tally_input.txt")
        # parse and plot the output data files
        os.system("python my_interactive_parser.py tally plot -tf "+dir_path+"example_tally*.txt -sk cycle -dn cool_counts -x bins -xlab 'bin [#]'  -y odd_counts  -ylab 'Counts [#]'")
