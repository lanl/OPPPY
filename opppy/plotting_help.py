...
def add_plot_options(parser):
    ...
    parser.add_argument('-fr','--figure_resolution', dest='figure_resolution', help='figure resolution in  dpi', nargs=1, type=float, default=300.0)
    ...
    parser.add_argument('-sz','--scale_z', dest='scale_z', help='scale z values', type=float, default=1.0)
